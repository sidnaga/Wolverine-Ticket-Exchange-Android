...
public class your_tweets extends AppCompatActivity {
        ...
        tweets_ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists()){
                    Toast.makeText(getApplicationContext(), "You have not tweeted yet", Toast.LENGTH_SHORT).show();
                }
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot tweet : dataSnapshot.getChildren()) {
                        ...
                        if(Tweet.getSender().equals(auth.getCurrentUser().getEmail())) {
